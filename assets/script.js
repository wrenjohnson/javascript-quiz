...
var seeHighscoresBtn = document.querySelector(`#seeHighscoresBtn`); 
...
var questionObj = {
    questions: [ 
        ...
        'Which of the following is is a JavaScript command?'
    ],
    answers: [ 
        [`<js>`, `correct:<script>`, `<javascript>`, `<scripting>`],
        ['number', 'boolean', 'object', 'text']
        ['ctrl+/', 'ctrl+click', 'alt+click', 'alt+c']
...
function setUpGame() {
    ...
    seeHighscoresBtn.style.display = `block`; 
...
function startGame() {
    ...
    seeHighscoresBtn.style.display = `none` 
...
function createAnswerElements(currentQuestionIndx) {
